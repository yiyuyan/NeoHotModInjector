...
public class MethodHandlesLookupTransformer extends ExportableClassFileTransformer {

    public MethodHandlesLookupTransformer() {
    ...
    public byte[] transformClass(ClassLoader loader,
        ...
        ClassVisitor cv = new ClassVisitor(Opcodes.ASM9, cw) {
            ...
            public MethodVisitor visitMethod(int access,
                ...
                if (name.equals("hasFullPrivilegeAccess") &&

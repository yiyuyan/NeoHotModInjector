...
public class InjectorConfig {
    ...
    public static final ModConfigSpec.BooleanValue INJECT_CONFIRM_SCREEN = BUILDER.comment("When it's true and there's the BetterModList in the ModList,it will show a confirm screen.").define("confirm_screen",true);
